...
static const GLenum FMT_PLANES[MTY_COLOR_FORMAT_MAX][3][3] = {
	...
	[MTY_COLOR_FORMAT_I420]		  = {{GL_R8,       GL_RED,  GL_UNSIGNED_BYTE}, 			     {GL_R8,  GL_RED, GL_UNSIGNED_BYTE},   {GL_R8,  GL_RED, GL_UNSIGNED_BYTE}},
	[MTY_COLOR_FORMAT_NV12]		  = {{GL_R8,       GL_RED,  GL_UNSIGNED_BYTE}, 			     {GL_RG8,  GL_RG, GL_UNSIGNED_BYTE},   {0}},
