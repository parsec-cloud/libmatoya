...
constant float PQ_m_1 = 2610.0f / 4096.0f / 4.0f;
constant float PQ_m_1_d = 1.0f / PQ_m_1;
constant float PQ_m_2 = 2523.0f / 4096.0f * 128.0f;
constant float PQ_m_2_d = 1.0f / PQ_m_2;
constant float PQ_c_1 = 3424.0f / 4096.0f;
constant float PQ_c_2 = 2413.0f / 4096.0f * 32.0f;
constant float PQ_c_3 = 2392.0f / 4096.0f * 32.0f;

constant float HDR10_MAX_NITS = 10000.0f;
constant float SDR_MAX_NITS = 80.0f; // the reference sRGB luminance is 80 nits (aka the brightness of paper white)
...
fragment float4 fs(
	...
	// // TODO: Conditional on HDR...linearize
