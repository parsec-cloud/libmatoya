...
typedef enum {
	...
	MTY_EVENT_TOUCH          = 77, ///< Touch input event has occurred.
...
typedef struct {
	uint32_t count; ///< Number of touch points
	void *inputs;  ///< Pointer to native touch info
} MTY_TouchEvent;
...
typedef struct MTY_Event {
	...
	union {
		...
		MTY_TouchEvent touch;           ///< Valid on MTY_EVENT_TOUCH.
