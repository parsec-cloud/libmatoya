...
typedef enum {
	...
	MTY_EVENT_HOVER          = 27, ///< Mouse is hovering or has left the window.
	MTY_EVENT_SCALE          = 28, ///< The scale factor has been changed.
...
typedef struct MTY_Event {
	...
	union {
		...
		bool hover;              ///< Valid on MTY_EVENT_HOVER, the hover state.
	};
} MTY_Event;
