...
void MTY_RWLockDestroy(MTY_RWLock **rwlock)
{
	...
	MTY_RWLock *ctx = MTY_PointerExchange((void **) rwlock, NULL);
...
void MTY_WaitableDestroy(MTY_Waitable **waitable)
{
	...
	MTY_Waitable *ctx = MTY_PointerExchange((void **) waitable, NULL);
...
void MTY_ThreadPoolDestroy(MTY_ThreadPool **pool, MTY_AnonFunc detach)
{
	...
	MTY_ThreadPool *ctx = MTY_PointerExchange((void **) pool, NULL);
